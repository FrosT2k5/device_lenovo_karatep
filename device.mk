...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_karatep.xml:system/etc/mixer_paths_karatep.xml \
...
#TODO : Cam mostly same still need to verify
# Camera
PRODUCT_PACKAGES += \
    camera.msm8937 \
    Snap \
...
# MISC - NOT SURE WHAT AND WHY, yeah me too
PRODUCT_COPY_FILES += \
...
PRODUCT_PACKAGES += \
    ...
    init.target.rc \
    ueventd.qcom.rc
##TODO:what? Init RC files (for which permissions are different when compared to stock)
PRODUCT_COPY_FILES += \
